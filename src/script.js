const nounou = ['location', 'href', 'querySelector', 'https://discord.com/oauth2/authorize?client_id=clientid&scope=bot&permissions=8', '©\x20Made\x20by\x20NouNou\x20due\x20spotify', 'createTextNode', 'button.s-m-btn', 'createElement', 'footer', 'onclick', 'button.hero-btn', 'appendChild'];
